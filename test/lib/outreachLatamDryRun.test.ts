...
// Live network + hundreds of MB: opt in with RUN_LIVE=1 (never part of the normal suite).
describe.skipIf(process.env.RUN_LIVE !== '1')('LATAM live dry run (no DB writes)', () => {
