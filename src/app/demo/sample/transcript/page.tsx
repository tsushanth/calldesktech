...
export default function SampleTranscriptPage() {
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-primary-600 font-medium">Sample Demo Complete</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            See how the AI receptionist handled the call for {profile.businessName}
          </p>
        </div>
            ...
            <div>
              ...
              <Card className="mt-6 bg-gradient-to-br from-primary-50 to-blue-50 border-primary-200">
                <div className="text-center">
                  ...
                  <h4 className="font-medium text-primary-900 mb-1">Ready for Your Business?</h4>
                  <p className="text-sm text-primary-700 mb-3">
                    Try a personalized demo with your own business details, or get started right away.
                  </p>
                </div>
              </Card>
            </div>
          ...
          <Card className="border-2 border-primary-500 bg-primary-50">
            <div className="text-center">
              <h2 className="text-xl font-bold text-gray-900 mb-2">
                Want to Try With Your Business?
              </h2>
              <p className="text-gray-600 mb-4">
                Create a personalized AI receptionist for your business
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/demo/focused">
                  <Button size="lg">
