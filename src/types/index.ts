...
export interface FlowNode {
  id: string;
  type: 'greeting' | 'extraction' | 'function' | 'knowledge_base' | 'transfer' | 'goodbye' | 'payment' | 'logic_split' | 'press_digit' | 'sms' | 'code' | 'mcp' | 'subagent' | 'subflow_ref' | 'agent_transfer' | 'extract_variable'
