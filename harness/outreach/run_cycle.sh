...
# The sixteen customer-discovery verticals keep state under ~/.calldesk-<vertical>-outreach
...
case "$PRODUCT" in
  ...
  childcare|accounting|realestate|lodging|funeral|physio|taxi|vets) BASE="$HOME/.calldesk-${PRODUCT}-outreach" ;;
